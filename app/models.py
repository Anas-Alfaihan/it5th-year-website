...
class Dispatch(models.Model):
    ...
    languageCourseDurationYear = models.IntegerField(default=0)
    languageCourseDurationMonth = models.IntegerField(default=0)
    languageCourseDurationDay = models.IntegerField(default=0)
    dispatchBeginDate = models.DateField()
